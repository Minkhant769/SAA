...
'''sh
aws s3api create-bucket --bucket acl-example-mk-123 --region us-east-1 
'''
## Turn of Public Access for ACLs

'''sh
aws s3api put-public-access-block \
--bucket acl-example-mk-123 \
...
## Access Bucket from Account
'''sh
touch bootcamp.txt
aws s3 cp bootcamp.txt s3://acl-example-mk-123
